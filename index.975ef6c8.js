...
function onSubmit(e) {
    ...
    (0, _getApi.getPicture)(query, page, perPage).then(({ data  })=>{
        console.log(data);
        if (data.totalHits === 0) alertNoImagesByKeyword();
        else {
            (0, _galleryCards.createCards)(data.hits);
...
function alertEndImagesByThisKeyword() {
    (0, _notiflixDefault.default).Notify.failure("We're sorry, but you've reached the end of search results.");
}

},{"notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./scripts/getApi":"iCtTH","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./scripts/galleryCards":"ciYYQ","./sass/index.scss":"9OQSl"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"iCtTH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPicture", ()=>getPicture);
...
},{}],"kaxSc":[function() {},{}],"ciYYQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createCards", ()=>createCards);
const gallery = document.querySelector(".gallery");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9OQSl":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
